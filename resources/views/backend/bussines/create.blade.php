...
@section('content')
 ...
 <!-- START BREADCRUMB -->
    <ul class="breadcrumb">
        ...
        <li><a class="active">Crear Negocio</a></li>
    </ul>
<!-- END BREADCRUMB -->         
            ...
            <div class="col-md-12">
                 <div class="panel panel-danger">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Crear nuevo negocio</h3>
                                </div>
                               
                                <div class="panel-body">
                                           
                                               {!! Form::open(['route'=>'shoes.bussine.store','method'=>'POST','files'=>true]) !!}
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="form-group">
                                                  ...
                                                  <div class="row" >
                                                        ...
                                                        <input class="knob" data-width="150" data-min="0" data-max="5" data-fgColor="#61C0E6" data-displayPrevious=true value="3" name="ranking" id="ranking"/>
                                                        </div>
