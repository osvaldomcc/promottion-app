                                ...
                                <br/>
                                 <div class="col-md-5 pull-left">
                                    ...
                                    <div style="margin-top:40px;" >
                                           ...
                                           &nbsp;&nbsp;&nbsp;<a onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});" href="{{ route('delete_category',0) }}" id="delete" class="btn btn-rounded btn-danger">Eliminar</a><p><small>Todo</small></p>
                                      </div>
                                   </div>
                                   
                                    
                                   
                              {!! Form::open(['route'=>'shoes.category.index','method'=>'GET']) !!}
                             ...
                             {!! Form::close() !!}
                                ...
                                <div class="panel-body">
                                        ...
                                        <table class="table table-bordered table-striped table-actions" id="customers2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><i class="{{ $category->icono }}"></i></center>
                                                    </td>
                                                    <td>
                                                        {{ $category->created_at->format('d-m-Y h:i:s A') }}
                                                    </td>
                                                     <td>
                                                        <a class="btn btn-info btn-rounded btn-condensed btn-sm" href="{{ route('shoes.category.show',$category->id) }}" data-toggle="tooltip" data-placement="top" title="Observar" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});"><span class="fa fa-eye"></span></a>
                                                        <a class="btn btn-warning btn-rounded btn-condensed btn-sm" href="{{ route('shoes.category.edit',$category->id) }}" data-toggle="tooltip" data-placement="top" title="Editar" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'warning'});"><span class="fa fa-edit"></span></a>
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
                                                    <td colspan="6">
                                                        <center>
                                                           <div class="col-md-8 col-md-offset-2">
                                                            ...
                                                            <strong>Atención!</strong> No hay categorías creadas.
                                                            </div>
                                                           </div>
                                                        </center>
                                                    </td>
                                 ...
                                 <div class="panel-footer">
                                    <a class="btn btn-rounded btn-primary" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});" href="{{ route('shoes.category.create') }}"><span class="fa fa-plus"></span>Añadir una nueva categoría</a>
                                </div>    
                    </div> 
            </div>
        </div>
