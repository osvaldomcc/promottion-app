...
@section('content')
 ...
 <!-- START BREADCRUMB -->
    <ul class="breadcrumb">
        ...
        <li><a class="active">Listado de marcadores</a></li>
    </ul>
<!-- END BREADCRUMB -->         
            ...
            <div class="col-md-12">
                 <div class="panel panel-danger">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Listado de marcadores</h3>
                                </div>
                                <br/><br/>
                                <br/>
                                <br/>
                              ...
                              {!! Form::open(['route'=>'shoes.marker.index','method'=>'GET']) !!}
                                                    ...
                                                    <td colspan="6">
                                                        <center>
                                                           <div class="col-md-8 col-md-offset-2">
                                                            ...
                                                            <strong>Atención!</strong> No hay marcadores creados.
                                                            </div>
                                                           </div>
                                                        </center>
                                                    </td>
