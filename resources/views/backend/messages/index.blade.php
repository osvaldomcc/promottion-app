...
@section('content')
 ...
 <!-- START BREADCRUMB -->
    <ul class="breadcrumb">
        ...
        <li><a class="active">Listado de mensajes</a></li>
    </ul>
<!-- END BREADCRUMB -->         
                                ...
                                <br/>
                                 <div class="col-md-5 pull-left">
                                    ...
                                    <div style="margin-top:40px;" >
                                           ...
                                           &nbsp;&nbsp;&nbsp;<a onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});" href="{{ route('delete_message',0) }}" id="delete" class="btn btn-rounded btn-danger">Eliminar</a><p><small>Todo</small></p>
                                      </div>
                                   </div>
                                   
                                    
                                   
                              {!! Form::open(['route'=>'shoes.message.index','method'=>'GET']) !!}
                                <div class="col-md-3 pull-right" >
                                <div class="input-group">
                                  {!! Form::text('name',null,['class'=>'form-control','placeholder'=>'Correo']) !!}
                                        ...
                                        <table class="table table-bordered table-striped table-actions" id="customers2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="switch switch-small">
                                                            <input type="checkbox" class="selected" id="{{ $message->id }}" /> 
                                                            <span></span>
                                                        </label>
                                                        &nbsp; {{ $message->comenter }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        {{ $message->created_at->format('d-m-Y h:i:s A') }}
                                                    </td>
                                                     <td>
                                                        <a class="btn btn-info btn-rounded btn-condensed btn-sm" href="{{ route('shoes.message.show',$message->id) }}" data-toggle="tooltip" data-placement="top" title="Observar" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});"><span class="fa fa-eye"></span></a>
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
