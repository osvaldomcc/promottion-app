...
@section('content')
 ...
 <!-- START BREADCRUMB -->
    <ul class="breadcrumb">
        ...
        <li><a class="active">Listado de municipios</a></li>
    </ul>
<!-- END BREADCRUMB -->         
                                 ...
                                 <div class="col-md-5 pull-left">
                                    ...
                                    <div style="margin-top:40px;" >
                                           ...
                                           <label class="switch switch-small">
                                            ...
                                            &nbsp;&nbsp;&nbsp;<a onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});" href="{{ route('delete_municipality',0) }}" id="delete" class="btn btn-rounded btn-danger">Eliminar</a><p><small>Todo</small></p>
                                      </div>
                                   </div>
                                   
                                    
                                   
                              {!! Form::open(['route'=>'shoes.municipality.index','method'=>'GET']) !!}
                             ...
                             {!! Form::close() !!}
                                ...
                                <div class="panel-body">
                                        ...
                                        <table class="table table-bordered table-striped table-actions" id="customers2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="switch switch-small">
                                                            <input type="checkbox" class="selected" id="{{ $municipality->id }}" /> 
                                                            <span></span>
                                                        </label>
                                                        &nbsp; {{ $municipality->name }}
                                                    </td>
                                                    ...
                                                    <td>
                                                         {{ $municipality->city->country->name }}
                                                    </td>
                                                    <td>
                                                         {{ $municipality->lang->language }}
                                                    </td>
                                                    <td>
                                                        {{ $municipality->created_at->format('d-m-Y h:i:s A') }}
                                                    </td>
                                                     <td>
                                                        <a class="btn btn-info btn-rounded btn-condensed btn-sm" href="{{ route('shoes.municipality.show',$municipality->id) }}" data-toggle="tooltip" data-placement="top" title="Observar" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});"><span class="fa fa-eye"></span></a>
                                                        <a class="btn btn-warning btn-rounded btn-condensed btn-sm" href="{{ route('shoes.municipality.edit',$municipality->id) }}" data-toggle="tooltip" data-placement="top" title="Editar" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'warning'});"><span class="fa fa-edit"></span></a>
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
                                                    <td colspan="6">
                                                        <center>
                                                           <div class="col-md-8 col-md-offset-2">
                                                            ...
                                                            <strong>Atención!</strong> No hay municipios creados.
                                                            </div>
                                                           </div>
                                                        </center>
                                                    </td>
                                 ...
                                 <div class="panel-footer">
                                    <a class="btn btn-rounded btn-primary" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});" href="{{ route('shoes.municipality.create') }}"><span class="fa fa-plus"></span>Añadir un nuevo municipio</a>
                                </div>    
                    </div> 
            </div>
        </div>
