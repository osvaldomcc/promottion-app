...
@section('content')
 ...
 <!-- START BREADCRUMB -->
    <ul class="breadcrumb">
        ...
        <li><a class="active">Editar Subcategoría</a></li>
    </ul>
<!-- END BREADCRUMB -->         
            ...
            <div class="col-md-12">
                 <div class="panel panel-danger">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Editar subcategoría</h3>
                                </div>
                               
                                <div class="panel-body">
                                           
                                               {!! Form::model($subcategory,['route'=>['shoes.subcategory.update',$subcategory->id],'method'=>'PUT']) !!}
