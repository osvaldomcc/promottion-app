...
@section('content')
 ...
 <!-- START BREADCRUMB -->
    <ul class="breadcrumb">
        ...
        <li><a class="active">Listado de subcategorías</a></li>
    </ul>
<!-- END BREADCRUMB -->         
            ...
            <div class="col-md-12">
                 <div class="panel panel-danger">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Listado de subcategorías</h3>
                                </div>
                                <br/><br/>
                                <br/>
                                <br/>
                                 <div class="col-md-5 pull-left">
                                    ...
                                    <div style="margin-top:40px;" >
                                           ...
                                           &nbsp;&nbsp;&nbsp;<a onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});" href="{{ route('delete_subcategory',0) }}" id="delete" class="btn btn-rounded btn-danger">Eliminar</a><p><small>Todo</small></p>
                                      </div>
                                   </div>
                                   
                                    
                                   
                              {!! Form::open(['route'=>'shoes.subcategory.index','method'=>'GET']) !!}
                             ...
                             {!! Form::close() !!}
                                ...
                                <div class="panel-body">
                                        ...
                                        <table class="table table-bordered table-striped table-actions" id="customers2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="switch switch-small">
                                                            <input type="checkbox" class="selected" id="{{ $subcategory->id }}" /> 
                                                            <span></span>
                                                        </label>
                                                        &nbsp; {{ $subcategory->name }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <center><i class="{{ $subcategory->icono }}"></i></center>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <a class="btn btn-info btn-rounded btn-condensed btn-sm" href="{{ route('shoes.subcategory.show',$subcategory->id) }}" data-toggle="tooltip" data-placement="top" title="Observar" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});"><span class="fa fa-eye"></span></a>
                                                        <a class="btn btn-warning btn-rounded btn-condensed btn-sm" href="{{ route('shoes.subcategory.edit',$subcategory->id) }}" data-toggle="tooltip" data-placement="top" title="Editar" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'warning'});"><span class="fa fa-edit"></span></a>
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
                                                    <td colspan="6">
                                                        <center>
                                                           <div class="col-md-8 col-md-offset-2">
                                                            ...
                                                            <strong>Atención!</strong> No hay subcategorías creadas.
                                                            </div>
                                                           </div>
                                                        </center>
                                                    </td>
                                 ...
                                 <div class="panel-footer">
                                    <a class="btn btn-rounded btn-primary" onClick="$.mpb('show',{value: [0,100],speed: -10,state: 'info'});" href="{{ route('shoes.subcategory.create') }}"><span class="fa fa-plus"></span>Añadir una nueva subcategoría</a>
                                </div>    
                    </div> 
            </div>
        </div>
